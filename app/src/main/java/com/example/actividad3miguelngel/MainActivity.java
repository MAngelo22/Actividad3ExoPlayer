package com.example.actividad3miguelngel;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onStart(){
        ...
        ExtractorMediaSource archivoMultimedia = new ExtractorMediaSource.Factory(dataSourceFactory)
                .createMediaSource(Uri.parse(/*"https://www.youtube.com/watch?v=cdqzfHixg8c.mp4"));*/
                        "https://www3.gobiernodecanarias.org/medusa/mediateca/iesgeneto/wp-content/uploads/sites/9/2013/11/paseo-virtual-final.mp4"));
